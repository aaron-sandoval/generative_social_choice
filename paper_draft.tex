...
As we don't provide formal proofs of satisfaction for other voting algorithms, false positives remain possible, but don't affect our conclusions. Results are shown in \Cref{tab:voting-axioms}. %These are best-effort empirical checks rather than formal proofs of satisfaction, so false positives remain possible.
